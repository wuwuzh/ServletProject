...
<script type="text/javascript">
    $(function() {
        $("#btn").click(function () {
            ...
            //     }
            // });
            var sucess_statement;
            var user_id_statement;
            $.post("loginServlet",
                {
                ...
                function(data){
                    ...
                    sucess_statement = json.success;
                    user_id_statement = json.user_id;
                    alert("userid: " + user_id_statement + "\nStatus: " + sucess_statement);
                });
        })
    })
</script>
